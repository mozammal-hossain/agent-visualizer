...
function App() {
  ...
  const { agents, selectedAgent, agentTools, agentStatuses, subagentTools, subagentCharacters, layoutReady, loadedAssets, workspaceFolders, availableProviders, agentProviderIds } = useExtensionMessages(getOfficeState, editor.setLastSavedLayout, isEditDirty)
  ...
  return (
    <div ref={containerRef} style={{ width: '100%', height: '100%', position: 'relative', overflow: 'hidden' }}>
      ...
      <ToolOverlay
        ...
        agentProviderIds={agentProviderIds}
        availableProviders={availableProviders}
      />
