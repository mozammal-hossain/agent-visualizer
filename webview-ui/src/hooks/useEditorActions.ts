...
export interface EditorActions {
  ...
  handleLaunchAgent: (providerId: string, folderPath?: string) => void
...
export function useEditorActions(
  ...
  const handleLaunchAgent = useCallback((providerId: string, folderPath?: string) => {
    vscode.postMessage({ type: 'launchAgent', providerId, folderPath })
  }, [])
