...
export const LAYOUT_FILE_DIR = '.agent-visualizer';
export const LAYOUT_FILE_NAME = 'layout.json';
export const LAYOUT_FILE_POLL_INTERVAL_MS = 2000;

// ── Settings Persistence ────────────────────────────────────
export const GLOBAL_KEY_SOUND_ENABLED = 'agent-visualizer.soundEnabled';

// ── VS Code Identifiers ─────────────────────────────────────
export const VIEW_ID = 'agent-visualizer.panelView';
export const COMMAND_SHOW_PANEL = 'agent-visualizer.showPanel';
export const COMMAND_EXPORT_DEFAULT_LAYOUT = 'agent-visualizer.exportDefaultLayout';
export const WORKSPACE_KEY_AGENTS = 'agent-visualizer.agents';
