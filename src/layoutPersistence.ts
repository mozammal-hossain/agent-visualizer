...
export function readLayoutFromFile(): Record<string, unknown> | null {
  ...
  try {
    ...
    console.error('[Agent Visualizer] Failed to read layout file:', err);
    return null;
  }
}
...
export function writeLayoutToFile(layout: Record<string, unknown>): void {
  ...
  try {
    ...
    console.error('[Agent Visualizer] Failed to write layout file:', err);
  }
}
...
export function watchLayoutFile(
  ...
  function checkForChange(): void {
    ...
    try {
      ...
      console.error('[Agent Visualizer] Error checking layout file:', err);
    }
  }
